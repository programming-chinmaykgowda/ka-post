...
$sql = "SELECT DISTINCT AO_Name,AO_Facility_ID FROM posb_karnataka_2022_23 WHERE Region_ID = '$region' AND Division_ID = '$division' AND Sub_Division_ID = '$subdivision'";

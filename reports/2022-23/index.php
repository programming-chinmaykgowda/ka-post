...
@media screen and (max-height: 527px) and (orientation: landscape) {
  ...
  <body>
       <h1>POSB New A/cs Report 2022-23  Region/Division/Sub Division/AO wise</h1>
		<div id="options-container">
			<div style="display: flex; justify-content: space-between;">
				<div></div>
				<div style="display: flex; align-items: flex-end; flex-direction: column;">
					<h3 id="dataavailablefrom"> Data Available from: 01/04/2022 </h3>
					<h3 class="blinking-text" id="dataavailableupto">  Data Updated upto: 31/03/2023  </h3>
				</div>
			</div>
	    	...
	    	<div>
			    ...
			    <select id="category">
			      ...
			      <!--<option value="A_c_Closed">A/Cs Closed</option>	-->
						<option value="Net_Acs">Net A/cs Opened</option>	
						<!--<option value="Cert_Issued">Cert Issued</option>	-->
						<!--<option value="Cert_Disch">Cert Disch</option>	-->
						<option value="Net_Cert">Net Certificate Issued</option> 
						<!--<option value="MSSC_Opened">MSSC Opened</option>	-->
						<!--<option value="Msscclosed">MSSC Closed</option>	-->
						<option value="Net_mssc">Net MSSC A/s Opened</option>	
						<option value="Total_Acs">Total A/cs opened(SB/Cert/MSSC)</option>	
						<option value="Total_closed">Total A/cs Closed(SB/Cert/MSSC)</option>	
						<option value = "Total_Net">Total Net A/cs(SB/Cert/MSSC)</option>
    ...
    <input type="text" id="sortBy" value="Name ASC " hidden />
      <h5> Note: The target is alloted by concerned Divisions</h5>
  </body>
</html>

...
@media screen and (max-height: 527px) and (orientation: landscape) {
  ...
  <body>
    <h1>POSB Net Addition Report 2024-25 Region/Division/Sub Division/AO wise</h1>
		<div id="options-container">
			<div style="display: flex; justify-content: space-between;">
				<div></div>
				<div style="display: flex; align-items: flex-end; flex-direction: column;">
					<h3 id="dataavailablefrom"> Data Available from: 01/04/2024 </h3>
					<h3 class="blinking-text"  id="dataavailableupto">  Duata Updated upto: 31/12/2024 </h3>
				</div>
			</div>
 ...
 <option value=">= 200">> 200</option>
    ...
    <input type="text" id="sortBy" value="Name ASC " hidden />
      <h5>Note: POSB Net target,percentage of  annual & proportion target achievement is only POSB A/cs including SSA A/cs. This exclude KVP/NSC/MSSC. </h5>
  </body>
</html>

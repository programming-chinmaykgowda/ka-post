...
$sql = "SELECT Division, Office_Name, Sub_Division, A_c_Opened, Office_Type
        FROM (
            SELECT Division, Office_Name, Sub_Division, A_c_Opened, Office_Type,
                ROW_NUMBER() OVER(PARTITION BY Division, Office_Type ORDER BY A_c_Opened DESC) AS row_num
...
echo "<h2 style='text-align:center;'>POSB- Top 3 Head Offices, Sub Offices & Branch Offices in Each Division under SK Region</h2>";

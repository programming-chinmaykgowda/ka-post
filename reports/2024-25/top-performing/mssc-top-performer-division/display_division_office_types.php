...
$sql = "SELECT Division, Office_Name, Sub_Division, mssc_ac, Office_Type
        FROM (
            SELECT Division, Office_Name, Sub_Division, mssc_ac, Office_Type,
                ROW_NUMBER() OVER(PARTITION BY Division, Office_Type ORDER BY mssc_ac DESC) AS row_num
...
echo "<h2 style='text-align:center;'>MSSC Top 3 Head Offices, Sub Offices & Branch Offices in Each Division under SK Region</h2>";

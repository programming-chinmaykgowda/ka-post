...
@media screen and (max-height: 527px) and (orientation: landscape) {
  ...
  <body>
    <h1>POSB New A/cs month wise for the financial year  2024-25 [Region/Division/Sub Division/AO wise]</h1>
   ...
   <div class="table-container" id="data"></div>
    ...
    <input type="text" id="sortBy" value="Name ASC " hidden />
      <h5>Note: The above target, total A/cs opened & annual target achievement/proportion target achievment is only POSB & SSA A/cs excluding MSSC/KVP/NSC.</h5>
  </body>
</html>

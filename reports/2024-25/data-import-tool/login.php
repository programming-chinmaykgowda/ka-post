...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $defaultCode = "Chinnu@2008"; // Replace with your default 6-10 digit alphanumeric code
...
<body>
    <div class="login-container">
        <h1>POSB Report 2024-25</h1>
           <h2>Login</h2></br>
           
        <form action="" method="post">
            <!--<label for="code">Enter password:</label>-->
            <input type="password" placeholder="Enter Password" name="code" id="code" maxlength="15" minlength="6" required>

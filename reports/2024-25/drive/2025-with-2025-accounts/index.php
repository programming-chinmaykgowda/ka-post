...
<html>
  <head>
    <title>2025 with 2025 A/cs</title>
...
@media screen and (max-height: 527px) and (orientation: landscape) {
  ...
  <body>
    <h1>POSB New A/cs opened during the Celebrate 2025 with 2025 accounts Drive period(09.12.24 to 28.12.24 [Region/Division/Sub Dn wise]</h1>
		<div id="options-container">
			<div style="display: flex; justify-content: space-between;">
				<div></div>
				<div style="display: flex; align-items: flex-end; flex-direction: column;">
					<h3 id="dataavailablefrom"> Data Available from: 09/12/2024 </h3>
					<!--<h3 class="blinking-text" id="dataavailableupto">  Data Updated upto: 25/11/2024  </h3>-->
				</div>
			</div>
	    	...
	    	<div>
			    ...
			    <select id="category">
			      <option value="">Select Category</option>
			             ...
			             <option value="A_c_Opened"> Total A/cs Opened</option>	
			            
                         <option value="mssc_tot"> Total MSSC Opened</option>	

          
                       
					
						<option value = "`%age`">Target Achieved</option>
   ...
   <div class="table-container" id="data"></div>
    ...
    <input type="text" id="sortBy" value="Name ASC " hidden />
      <h5>Note: Total A/cs opened is only POSB & SSA A/cs excluding KVP/NSC.</h5>
  </body>
</html>

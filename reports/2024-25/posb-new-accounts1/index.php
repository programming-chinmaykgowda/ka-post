...
@media screen and (max-height: 527px) and (orientation: landscape) {
  ...
  <body>
    <h1>POSB New A/cs Report 2024-25  Region/Division/Sub Division/AO wise</h1>
		<div id="options-container">
			<div style="display: flex; justify-content: space-between;">
				<div></div>
				<div style="display: flex; align-items: flex-end; flex-direction: column;">
					<h3 id="dataavailablefrom"> Data Available from: 01/04/2024 </h3>
					<h3 class="blinking-text" id="dataavailableupto">  Data Updated upto: 31/12/2024 </h3>
				</div>
			</div>
	    <div class="dropdown-and-dropdown-buttons">
	    	<div>
			    ...
			    <select id="category">
			      ...
			      <option value="A_c_Opened">POSB A/Cs Opened</option>	
    ...
    <input type="text" id="sortBy" value="Name ASC " hidden />
      <h5>Note: Annual target 2024-25 & POSB A/cs opened  including SSA A/cs and excluding KVP/NSC/MSSC.</h5>
  </body>
</html>

...
$sql = "SELECT DISTINCT AO_Name,AO_Facility_ID FROM posb_karnataka_2024_25_contest WHERE Region_ID = '$region' AND Division_ID = '$division' AND Sub_Division_ID = '$subdivision'";

...
@media screen and (max-height: 527px) and (orientation: landscape) {
  ...
  <body>
		...
		<div id="options-container">
			<div style="display: flex; justify-content: space-between;">
				...
				<div style="display: flex; align-items: flex-end; flex-direction: column;">
					...
					<h3 class="blinking-text" id="dataavailableupto">  Data Updated upto: 31/08/2024 </h3>
				</div>
			</div>
	    <div class="dropdown-and-dropdown-buttons">
	    	<div>
			    ...
			    <select id="category">
			      ...
			      <option value="total_posb_opened">POSB A/Cs Opened</option>	
    ...
    <input type="text" id="sortBy" value="Name ASC " hidden />
      <h5>Note: Annual target 2024-25 & POSB A/cs opened excluding SSA/KVP/NSC/MSSC.</h5>
  </body>
</html>

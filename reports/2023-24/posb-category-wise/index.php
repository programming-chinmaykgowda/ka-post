...
@media screen and (max-height: 527px) and (orientation: landscape) {
  ...
  <body>
    <h1>POSB New A/cs category wise 2023-24 Region/Division/Sub Division/AO wise</h1>
	    	...
	    	<div>
			    ...
			    <select id="category">
			      <option value="">Select Category</option>
			             ...
			             <option value="SB_AC">SB A/cs A/cs Opened</option>	
			             <option value="RD_AC">RD A/cs A/cs Opened</option>	
					     <option value="TD_AC">TD A/cs A/cs Opened</option>	
					
						<option value="SSA_AC">SSA A/cs Opened</option> 
						
						<option value="MSSC_AC">MSSC A/cs Opened</option>	
						<option value="TOTAL_AC_OPENED">Total A/cs Opened</option>	

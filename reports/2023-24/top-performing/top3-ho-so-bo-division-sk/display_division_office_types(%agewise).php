...
$sql = "SELECT Division, Office_Name, Sub_Division, Total_Acs, Achievement, Office_Type
        FROM (
            SELECT Division, Office_Name, Sub_Division, Total_Acs, Achievement, Office_Type,
                ROW_NUMBER() OVER(PARTITION BY Division, Office_Type ORDER BY Achievement DESC) AS row_num
...
echo "<h2 style='text-align:center;'>Top 3 Head Offices, Sub Offices & Branch Offices in Each Division under SK Region(Percentage of Achievement wise 2023-24)</h2>";
...
while ($row = $result->fetch_assoc()) {
    ...
    echo "<tr>
        ...
        <td class='small-column'>$achievement</td>

...
@media screen and (max-height: 527px) and (orientation: landscape) {
  ...
  <body>
    <h1>POSB New A/cs Report 2023-24  Region/Division/Sub Division/AO wise</h1>
		<div id="options-container">
			<div style="display: flex; justify-content: space-between;">
				<div></div>
				<div style="display: flex; align-items: flex-end; flex-direction: column;">
					<h3 id="dataavailablefrom"> Data Available from: 01/04/2023 </h3>
					<h3 class="blinking-text" id="dataavailableupto">  Data Updated upto: 31/03/2024 </h3>
				</div>
			</div>
	    	...
	    	<div>
			    ...
			    <select id="category">
			      <option value="">Select Category</option>
			        <!--<option value="2022_23">A/cs Opened in 2022-23</option>-->

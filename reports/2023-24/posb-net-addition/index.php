...
@media screen and (max-height: 527px) and (orientation: landscape) {
  ...
  <body>
    <h1>POSB Net Addition Report 2023-24 Region/Division/Sub Division/AO wise</h1>
		<div id="options-container">
			<div style="display: flex; justify-content: space-between;">
				<div></div>
				<div style="display: flex; align-items: flex-end; flex-direction: column;">
					<h3 id="dataavailablefrom"> Data Available from: 01/04/2023 </h3>
					<h3 class="blinking-text"  id="dataavailableupto">  Duata Updated upto: 31/03/2024  </h3>
				</div>
			</div>
	    <div class="dropdown-and-dropdown-buttons">
	    	<div>
			    ...
			    <select id="category">
			      ...
			      <!--<option value="A_c_Opened">A/Cs Opened</option>	-->
			      <!--<option value="A_c_Closed">A/Cs Closed</option>	-->
						<option value="Net_Acs">Net A/cs</option>	
						<!--<option value="Cert_Issued">Cert Issued</option>	-->
						<!--<option value="Cert_Disch">Cert Disch</option>	-->
						<option value="Net_Cert">Net Cert</option> 
						<!--<option value="MSSC_Opened">MSSC Opened</option>	-->
						<!--<option value="Msscclosed">MSSC Closed</option>	-->
						<option value="Net_mssc">Net MSSC</option>	
						<option value="Total_Acs">Total A/cs opened</option>	
						<option value="Total_closed">Total A/cs Closed</option>	
						<option value = "Total_Net">Total Net A/cs</option>
						<option value = "`%age`">Yearly Target Acheived</option>
						<option value = "`%age1`">Proprotion Target Acheived</option>					
			    </select>
			    <select id="top-bottom-offices">
			        ...
			        <option value="= < -1">Negative Growth</option>
	    ...
	    <h3 id="showingresults">Showing <span id="result-count"></span> results</h3>
    ...
    <input type="text" id="sortBy" value="Name ASC " hidden />
      <h5>Note: The exact target allotted to each office by the Division will be uploaded after receiving the data from the Divisions.</h5>
  </body>
</html>
